...
(define-resource catalog ()
  ...
  :properties `((:title :string ,(s-prefix "dcterms:title"))
                ...
                (:license :string ,(s-prefix "dcterms:license"))
                (:rights :string ,(s-prefix "dcterms:rights"))
                (:spatial :string ,(s-prefix "dcterms:spatial"))
                (:homepage :string ,(s-prefix "foaf:homepage")))
  :has-one `((agent :via ,(s-prefix "dcterms:publisher")
                        :as "publisher")
...
(define-resource dataset ()
  ...
  :properties `((:title :string ,(s-prefix "dcterms:title"))
                ...
                (:temporal :string ,(s-prefix "dcterms:temporal"))
                (:accrual-periodicity :string ,(s-prefix "dcterms:accrualPeriodicity"))
...
(define-resource distribution ()
  ...
  :has-one `((dataset :via ,(s-prefix "dcat:distribution")
                      :inverse t
                      :as "dataset")
             (format :via ,(s-prefix "dcterms:format")
                     :as "format"))
  :features `(include-uri)
...
(define-resource format ()
  :class (s-prefix "dcterms:MediaTypeOrExtent")
  :properties `((:name :string ,(s-prefix "rdfs:label"))
                (:labels :language-string-set ,(s-prefix "dcterms:description")))
  :has-many `((distribution :via ,(s-prefix "dcterms:format")
                            :inverse t
                            :as "distributions"))
